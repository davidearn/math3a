...
The full structure of the exam can be downloaded [here](./3af_2025_structure.pdf).

It is a good idea to read over this (mostly blank) document so that
you are familiar with the structure of the exam paper.

**Please remember that this is a 2.5 hour exam for which you will be
given 2.5 hours exactly (no extra time).**  (This contrasts the midterm
test, which was a 1.5 hour test for which you were given 3 hours if
you wanted it.)
