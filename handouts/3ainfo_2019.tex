...
\leftline{{\bf Tutor:} Ian Weih-Wadman (\emaillink{ian.weihwadman@gmail.com})}
\leftline{{\bf Office:} Hamilton Hall 105 (x24336)}
\leftline{{\bf Office Hours:} {Monday 3:30--4:30, Thursday 4:30--5:30}}
%%\leftline{{\bf Office Hours:} {Tuesdays 2:30--3:20pm (3D priority) and Wednesdays, 10:30--11:20am (3A priority)}}
\medskip
\leftline{{\bf Markers:} {Uyen Le (\emaillink{leu@mcmaster.ca}), Fletcher Gates (\emaillink{gatesf@mcmaster.ca})}}
\leftline{{\bf Office:} Hamilton Hall 303 (Uyen, x27246) and 403 (Fletcher, x24411)}
\begin{flushleft}{{\bf Marker Office Hours:} {Uyen or Fletcher are in
      the Math Help Centre on Mondays (4:30--6:30) and Tuesdays
      (3:30--5:30).  However, note that first year students always
      have priority in the Math Help Centre.}}\end{flushleft}
...
%% 63 tutor + 2x40 marker hours = 143 TA hours for ~80 students in winter 2019
%% 100 tutor + 2x30 marker hours = 160 TA hours for 105 students in fall 2019
...
Tuesday 29 October 2019 & 5:30--7:00pm & 
\href{http://library.mcmaster.ca/cct/class-dir/jhe-264}{JHE 264}\\
Tuesday 26 November 2019 & 5:30--7:00pm & 
\href{http://library.mcmaster.ca/cct/class-dir/jhe-264}{JHE 264}
\end{tabular}
\end{center}
\noindent
