...
\leftline{{\bf Office:} Hamilton Hall ???}
...
\leftline{{\bf Office:} Hamilton Hall 303 (Uyen, x27246) and ??? (Fletcher, x?????)}
\begin{flushleft}{{\bf Marker Office Hours:} {Uyen is in the Math Help Centre on
    ???Mondays 6:30pm--8:30pm???(to be confirmed).  However, note that first year students
