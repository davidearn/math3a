...
_Each assignment will have two components: a multiple-choice (MC)
online component that will be marked strictly on the basis of
participation (similar to the in-class polls) and an optional full
solutions component that can be submitted via
[Crowdmark](https://crowdmark.com/).  Marks will not be given for full
solutions, but feedback will be provided for any full solutions that
are submitted._
